...
def create_inventory_table():
    try:
        ...
        if table_exists:
            ...
            (inventoryID INTEGER PRIMARY KEY AUTOINCREMENT, restaurantName varchar(200) NOT NULL, itemName varchar(200) NOT NULL, quantity INT NOT NULL, stockLimit INT NOT NULL,
